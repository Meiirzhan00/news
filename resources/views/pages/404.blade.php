                  ...
                  <div>
                    ...
                    >
                      ...
                      >
                        ...
                        <li class="nav-item">
                          <a class="nav-link" href="../../../public/pages/business.html">Business</a>
                        </li>
                        <li class="nav-item">
                          <a class="nav-link" href="../../../public/pages/sports.html">Sports</a>
                        </li>
                        <li class="nav-item">
                          <a class="nav-link" href="art.blade.php">Art</a>
                        </li>
                        <li class="nav-item">
                          <a class="nav-link" href="politics.blade.php">POLITICS</a>
                        </li>
                        <li class="nav-item">
                          <a class="nav-link" href="travel.blade.php">Travel</a>
                        </li>
                        <li class="nav-item">
                          <a class="nav-link" href="contactus.blade.php">Contact</a>
                        </li>
                      </ul>
                    </div>
                  </div>
    ...
    <footer>
          <div class="footer-top">
            <div class="container">
              <div class="row">
                <div class="col-sm-5">
                  <img src="../../../public/assets/images/logo.svg" class="footer-logo" alt="" />
                    ...
                    <div class="col-sm-12">
                      <div class="footer-border-bottom pb-2">
                        <div class="row">
                          <div class="col-3">
                            <img
                              src="../../../public/assets/images/dashboard/home_1.jpg"
                              alt="thumb"
                              class="img-fluid"
                            />
                          </div>
                    ...
                    <div class="col-sm-12">
                      <div class="footer-border-bottom pb-2 pt-2">
                        <div class="row">
                          <div class="col-3">
                            <img
                              src="../../../public/assets/images/dashboard/home_2.jpg"
                              alt="thumb"
                              class="img-fluid"
                            />
                          </div>
                    ...
                    <div class="col-sm-12">
                      <div>
                        <div class="row">
                          <div class="col-3">
                            <img
                              src="../../../public/assets/images/dashboard/home_3.jpg"
                              alt="thumb"
                              class="img-fluid"
                            />
                          </div>
