                ...
                <div class="col-sm-12">
                    <div class="card" data-aos="fade-up">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-sm-12">
                                    <h1 class="font-weight-600 mb-4" style="text-transform: uppercase;">
                                        {{$rubricOne->name}}
                                    </h1>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-8">
                                    @foreach($rubricOne->news as $news)
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8 grid-margin">
                                            <h2 class="font-weight-600 mb-2">
                                                <a href="{{route('onePage',$news->id)}}" style="color: #3a3a3a;">{{$news->title}}</a>
                                            </h2>
